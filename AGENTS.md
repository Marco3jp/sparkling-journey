...
- 2026-04-10: Vite 8 正式版 (8.0.8) へのアップグレードに伴い Vitest を 4.1.4 へ更新することでテストが復活。`@tailwindcss/vite` と `@vitejs/plugin-react` も Vite 8 対応済みの最新版 (4.2.2 / 6.0.1) へ合わせて更新が必要。
